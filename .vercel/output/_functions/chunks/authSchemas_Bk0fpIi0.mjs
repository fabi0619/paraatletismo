...
const loginSchema = z.object({
  usuario: z.string().min(1, "El correo electrónico es requerido").email("Ingrese un correo electrónico válido"),
...
const registerCoachSchema = registerAthleteSchema.omit({
...
const editCoachSchema = registerCoachSchema.extend({
...
const editAthleteSchema = registerAthleteSchema.extend({
  password: z.string().min(6, "La contraseña debe tener al menos 6 caracteres").optional().or(z.literal(""))
});

export { adminLoginSchema as a, editCoachSchema as b, registerCoachSchema as c, editAthleteSchema as e, loginSchema as l, registerAthleteSchema as r };
