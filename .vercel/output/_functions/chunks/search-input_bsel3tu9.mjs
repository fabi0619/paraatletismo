...
function SearchInput({
  ...
  return /* @__PURE__ */ jsxs(InputGroup, { className, children: [
    ...
    resultsCount !== void 0 && /* @__PURE__ */ jsxs(InputGroupAddon, { align: "inline-end", children: [
      resultsCount,
      " resultados"
    ] })
  ] });
...
export { InputGroup as I, SearchInput as S, InputGroupInput as a, InputGroupAddon as b, InputGroupButton as c };
