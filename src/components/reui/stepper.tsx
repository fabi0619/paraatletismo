...
interface StepperItemProps extends React.React.HTMLAttributes<HTMLDivElement> {
  step: number
  completed?: boolean
  disabled?: boolean
  loading?: boolean
...
interface StepperTriggerProps extends React.ButtonReact.HTMLAttributes<HTMLButtonElement> {
  asChild?: boolean
}
