...
export const AthleteForm: React.FC<AthleteFormProps> = ({
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      // saveAthlete should handle uploading the certificadoAfiliacion file to Storage if it's a File object
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
        ...
        <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-12">
          ...
          <div className={`space-y-6 ${stepper.currentStep === 0 ? "lg:col-span-8" : "lg:col-span-12"}`}>
            ...
            <div className={stepper.currentStep === 2 ? "" : "hidden"}>
              <GuardianInfoStep
                register={register}
                control={control}
                errors={errors}
            ...
            <div className={stepper.currentStep === 3 ? "" : "hidden"}>
              <SportInfoStep
                register={register}
                control={control}
                setValue={setValue}
